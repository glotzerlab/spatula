...
class PGOP {
    ...
    compute_symmetry(LocalNeighborhood& neighborhood, const float* R_ij, size_t group_idx) const;
     ...
     */
    double compute_pgop(LocalNeighborhood& neighborhood, const std::span<const float> R_ij) const;
