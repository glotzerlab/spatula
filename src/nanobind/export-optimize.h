...
//  *
//  * This shouldn't actually be used to extend the class but we need this to pass Optimizers
//  through
//  * from Python.
//  */
// class NbOptimizer : public Optimizer {
//     public:
//     NB_OBJECT_TRAMPOLINE(Optimizer, 5);
...
//     {
//         NB_OVERRIDE_PURE(std::unique_ptr<Optimizer>, Optimizer, "clone");
//     }
// };
